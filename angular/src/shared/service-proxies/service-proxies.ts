...
@Injectable()
export class LeaveAppServicesServiceProxy {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
     ...
     * @param leaveFiterId (optional) 
     * @param sorting (optional) 
     * @param skipCount (optional) 
     * @param maxResultCount (optional) 
     * @return Success
     */
    getAll(filter: string | undefined, nameFilter: string | undefined, categoryNameFilter: string | undefined, leaveFiterId: number | undefined, sorting: string | undefined, skipCount: number | undefined, maxResultCount: number | undefined): Observable<GetLeaveForViewDtoPagedResultDto> {
        let url_ = this.baseUrl + "/api/services/app/LeaveAppServices/GetAll?";
        if (filter === null)
        ...
        if (leaveFiterId === null)
            throw new Error("The parameter 'leaveFiterId' cannot be null.");
        else if (leaveFiterId !== undefined)
            url_ += "LeaveFiterId=" + encodeURIComponent("" + leaveFiterId) + "&";
        if (sorting === null)
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return _observableThrow(e) as any as Observable<GetLeaveForViewDtoPagedResultDto>;
                }
            } else
                return _observableThrow(response_) as any as Observable<GetLeaveForViewDtoPagedResultDto>;
        }));
    }

    protected processGetAll(response: HttpResponseBase): Observable<GetLeaveForViewDtoPagedResultDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = GetLeaveForViewDtoPagedResultDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap((_responseText: string) => {
     ...
     * @return Success
     */
    createOrEdit(body: LeaveDto | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/LeaveAppServices/CreateOrEdit";
        url_ = url_.replace(/[?&]$/, "");
     ...
     * @return Success
     */
    getId(id: number | undefined): Observable<Leave> {
        let url_ = this.baseUrl + "/api/services/app/LeaveAppServices/GetId?";
        if (id === null)
    ...
    protected processGetId(response: HttpResponseBase): Observable<Leave> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = Leave.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap((_responseText: string) => {
     ...
     * @return Success
     */
    getDetailId(id: number | undefined): Observable<GetAllLeaveDto[]> {
        let url_ = this.baseUrl + "/api/services/app/LeaveAppServices/GetDetailId?";
        if (id === null)
            throw new Error("The parameter 'id' cannot be null.");
        else if (id !== undefined)
            url_ += "id=" + encodeURIComponent("" + id) + "&";
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetDetailId(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetDetailId(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<GetAllLeaveDto[]>;
                }
            } else
                return _observableThrow(response_) as any as Observable<GetAllLeaveDto[]>;
        }));
    }

    protected processGetDetailId(response: HttpResponseBase): Observable<GetAllLeaveDto[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            if (Array.isArray(resultData200)) {
                ...
                for (let item of resultData200)
                    result200.push(GetAllLeaveDto.fromJS(item));
            }
            else {
                result200 = <any>null;
            }
     ...
     * @return Success
     */
    approvedLeave(input: number | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/LeaveAppServices/ApprovedLeave?";
        if (input === null)
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processApprovedLeave(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processApprovedLeave(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<void>;
                }
            } else
    ...
    protected processApprovedLeave(response: HttpResponseBase): Observable<void> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return Success
     */
    rejectedLeave(input: number | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/LeaveAppServices/RejectedLeave?";
        if (input === null)
            throw new Error("The parameter 'input' cannot be null.");
        else if (input !== undefined)
            url_ += "input=" + encodeURIComponent("" + input) + "&";
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processRejectedLeave(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processRejectedLeave(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<void>;
                }
            } else
    ...
    protected processRejectedLeave(response: HttpResponseBase): Observable<void> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
    ...
    delete(id: number | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/LeaveAppServices/Delete?";
        if (id === null)
            throw new Error("The parameter 'id' cannot be null.");
        else if (id !== undefined)
            url_ += "id=" + encodeURIComponent("" + id) + "&";
    ...
    getAllUsers(): Observable<EmployeeDto[]> {
        let url_ = this.baseUrl + "/api/services/app/LeaveAppServices/GetAllUsers";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processGetAllUsers(response: HttpResponseBase): Observable<EmployeeDto[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return Success
     */
    getAllLeaveCategory(): Observable<LeaveCategoryDto[]> {
        let url_ = this.baseUrl + "/api/services/app/LeaveAppServices/GetAllLeaveCategory";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetAllLeaveCategory(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetAllLeaveCategory(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<LeaveCategoryDto[]>;
                }
            } else
                return _observableThrow(response_) as any as Observable<LeaveCategoryDto[]>;
        }));
    }

    protected processGetAllLeaveCategory(response: HttpResponseBase): Observable<LeaveCategoryDto[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            if (Array.isArray(resultData200)) {
                result200 = [] as any;
                for (let item of resultData200)
                    result200.push(LeaveCategoryDto.fromJS(item));
            }
            else {
                result200 = <any>null;
            }
    ...
    getCurrentUser(): Observable<EmployeeDto> {
        let url_ = this.baseUrl + "/api/services/app/LeaveAppServices/GetCurrentUser";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processGetCurrentUser(response: HttpResponseBase): Observable<EmployeeDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
...
@Injectable()
export class LeaveCateoryAppServicesServiceProxy {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
     ...
     * @return Success
     */
    createOrEdit(body: LeaveCategoryDto | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/LeaveCateoryAppServices/CreateOrEdit";
        url_ = url_.replace(/[?&]$/, "");
...
export class UserServiceProxy {
     ...
     * @return Success
     */
    getUserStatus(): Observable<LeaveQuotaDto[]> {
        let url_ = this.baseUrl + "/api/services/app/User/GetUserStatus";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetUserStatus(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<LeaveQuotaDto[]>;
                }
            } else
                return _observableThrow(response_) as any as Observable<LeaveQuotaDto[]>;
        }));
    }

    protected processGetUserStatus(response: HttpResponseBase): Observable<LeaveQuotaDto[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            if (Array.isArray(resultData200)) {
                result200 = [] as any;
                for (let item of resultData200)
                    result200.push(LeaveQuotaDto.fromJS(item));
            }
            else {
                result200 = <any>null;
            }
...
export enum ApproveRejectedLeave {
    _0 = 0,
    _1 = 1,
    _2 = 2,
}
...
export class CreateUserDto implements ICreateUserDto {
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.leaveQuotaId = _data["leaveQuotaId"];
    ...
    toJSON(data?: any) {
        ...
        data["leaveQuotaId"] = this.leaveQuotaId;
...
export class GetAllLeaveDto implements IGetAllLeaveDto {
    id: number;
    employeeName: string | undefined;
    ...
    constructor(data?: IGetAllLeaveDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.isLeave = _data["isLeave"];
        }
    }

    static fromJS(data: any): GetAllLeaveDto {
        data = typeof data === 'object' ? data : {};
        let result = new GetAllLeaveDto();
        result.init(data);
        return result;
    }
...
export interface IGetAllLeaveDto {
    id: number;
    employeeName: string | undefined;
    fromDate: moment.Moment;
    toDate: moment.Moment;
...
export class GetLeaveForViewDto implements IGetLeaveForViewDto {
    product: LeaveDto;
    employeeName: string | undefined;
    leaveType: string | undefined;
    ...
    constructor(data?: IGetLeaveForViewDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(_data?: any) {
        if (_data) {
            this.product = _data["product"] ? LeaveDto.fromJS(_data["product"]) : <any>undefined;
            this.employeeName = _data["employeeName"];
            this.leaveType = _data["leaveType"];
    ...
    static fromJS(data: any): GetLeaveForViewDto {
        data = typeof data === 'object' ? data : {};
        let result = new GetLeaveForViewDto();
        result.init(data);
        return result;
    }
...
export interface IGetLeaveForViewDto {
    product: LeaveDto;
    employeeName: string | undefined;
    leaveType: string | undefined;
    casualLeaveBalance: number;
...
export class GetLeaveForViewDtoPagedResultDto implements IGetLeaveForViewDtoPagedResultDto {
    items: GetLeaveForViewDto[] | undefined;
    totalCount: number;

    constructor(data?: IGetLeaveForViewDtoPagedResultDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
        ...
        if (_data) {
            if (Array.isArray(_data["items"])) {
                ...
                for (let item of _data["items"])
                    this.items.push(GetLeaveForViewDto.fromJS(item));
            }
            this.totalCount = _data["totalCount"];
        }
    }

    static fromJS(data: any): GetLeaveForViewDtoPagedResultDto {
        data = typeof data === 'object' ? data : {};
        let result = new GetLeaveForViewDtoPagedResultDto();
        result.init(data);
        return result;
    }
    ...
    clone(): GetLeaveForViewDtoPagedResultDto {
        const json = this.toJSON();
        let result = new GetLeaveForViewDtoPagedResultDto();
        result.init(json);
        return result;
...
export interface IGetLeaveForViewDtoPagedResultDto {
    items: GetLeaveForViewDto[] | undefined;
    totalCount: number;
}
...
export class Leave implements ILeave {
    ...
    userId: number | undefined;
    usersFk: User;
    leaveCategoryId: number | undefined;
    leaveCategoryFk: LeaveCategory;
    fromDate: moment.Moment;
    toDate: moment.Moment;
    days: string | undefined;
    description: string | undefined;
    ...
    init(_data?: any) {
        if (_data) {
            this.id = _data["id"];
            this.userId = _data["userId"];
            this.usersFk = _data["usersFk"] ? User.fromJS(_data["usersFk"]) : <any>undefined;
            this.leaveCategoryId = _data["leaveCategoryId"];
            this.leaveCategoryFk = _data["leaveCategoryFk"] ? LeaveCategory.fromJS(_data["leaveCategoryFk"]) : <any>undefined;
            this.fromDate = _data["fromDate"] ? moment(_data["fromDate"].toString()) : <any>undefined;
            this.toDate = _data["toDate"] ? moment(_data["toDate"].toString()) : <any>undefined;
            this.days = _data["days"];
            this.description = _data["description"];
            this.status = _data["status"];
            this.isLeave = _data["isLeave"];
            this.leaveBalance = _data["leaveBalance"];
        }
    }
    ...
    toJSON(data?: any) {
        ...
        data["id"] = this.id;
        data["userId"] = this.userId;
        data["usersFk"] = this.usersFk ? this.usersFk.toJSON() : <any>undefined;
        data["leaveCategoryId"] = this.leaveCategoryId;
        data["leaveCategoryFk"] = this.leaveCategoryFk ? this.leaveCategoryFk.toJSON() : <any>undefined;
        data["fromDate"] = this.fromDate ? this.fromDate.toISOString() : <any>undefined;
        data["toDate"] = this.toDate ? this.toDate.toISOString() : <any>undefined;
        data["days"] = this.days;
        data["description"] = this.description;
...
export class LeaveCategory implements ILeaveCategory {
    id: number;
    leaveType: string | undefined;

    constructor(data?: ILeaveCategory) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): LeaveCategory {
        data = typeof data === 'object' ? data : {};
        let result = new LeaveCategory();
        result.init(data);
        return result;
    }
...
export class LeaveCategoryDto implements ILeaveCategoryDto {
    id: number | undefined;
    leaveType: string | undefined;

    constructor(data?: ILeaveCategoryDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): LeaveCategoryDto {
        data = typeof data === 'object' ? data : {};
        let result = new LeaveCategoryDto();
        result.init(data);
        return result;
    }
...
export class LeaveQuota implements ILeaveQuota {
    id: number;
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.sick = _data["sick"];
            this.casual = _data["casual"];
            this.annual = _data["annual"];
            this.totalLeave = _data["totalLeave"];
        }
    }

    static fromJS(data: any): LeaveQuota {
        data = typeof data === 'object' ? data : {};
        let result = new LeaveQuota();
        result.init(data);
        return result;
    }
...
export class LeaveQuotaDto implements ILeaveQuotaDto {
    id: number;
    employeeStatus: string | undefined;
    sick: number;
    casual: number;
    ...
    constructor(data?: ILeaveQuotaDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): LeaveQuotaDto {
        data = typeof data === 'object' ? data : {};
        let result = new LeaveQuotaDto();
        result.init(data);
        return result;
    }
...
export interface ILeaveQuotaDto {
    id: number;
    employeeStatus: string | undefined;
    sick: number;
    casual: number;
...
export class User implements IUser {
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.joiningDate = _data["joiningDate"] ? moment(_data["joiningDate"].toString()) : <any>undefined;
            this.leaveQuotaId = _data["leaveQuotaId"];
            this.leaveQuotasFk = _data["leaveQuotasFk"] ? LeaveQuota.fromJS(_data["leaveQuotasFk"]) : <any>undefined;
        }
    }
    ...
    toJSON(data?: any) {
        ...
        data["joiningDate"] = this.joiningDate ? this.joiningDate.toISOString() : <any>undefined;
        data["leaveQuotaId"] = this.leaveQuotaId;
        data["leaveQuotasFk"] = this.leaveQuotasFk ? this.leaveQuotasFk.toJSON() : <any>undefined;
        return data;
    }
